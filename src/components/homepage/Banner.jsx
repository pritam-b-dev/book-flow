...
const Banner = () => {
  return (
    <div className="hero min-h-[20vh] md:min-h-[30vh] bg-base-200 container mx-auto">
      <div className="hero-content text-center">
        <div className="max-w-2xl space-y-2">
          <h1 className="text-lg md:mt-2 md:text-5xl font-bold animate__animated animate__fadeInDown animate__slower">
            Find Your Next Read
          </h1>
